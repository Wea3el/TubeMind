...
class BoardWorkspace:
    ...
    any transient notice or warning generated by the last action. The active
    session and full session list are included so the UI can render the session
    selector and isolate the correct chat thread.
    """
